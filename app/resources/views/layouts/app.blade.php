...
<head>
    ...
    <title>RiskManagement | @yield('pagetitle')</title>
...
<body>
    <div id="app">
        @guest
        @else
        <nav style="background-color: rgba(255,0,0,0.1);" class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/home') }}">
                    <img style="height: 40px;" src="{{URL::asset('img/logo.png')}}" alt="">
                </a>
